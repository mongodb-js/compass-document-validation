...
describe('<Rule />', function() {
  beforeEach(function() {
    ...
    this.Rule = require('../../lib/components/rule');
    this.RuleCategoryRange = require('../../lib/components/rule-categories/range');
    this.RuleCategorySelector = require('../../lib/components/rule-category-selector');
  });
