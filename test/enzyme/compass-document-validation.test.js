...
const CompassDocumentValidationComponent = require('../../lib/components/compass-document-validation');
const ToggleButton = require('../../lib/components/toggle-button');

// use chai-enzyme assertions, see https://github.com/producthunt/chai-enzyme
chai.use(chaiEnzyme());

describe('<CompassDocumentValidationComponent />', function() {
  let component;

  beforeEach(function() {
    component = mount(<CompassDocumentValidationComponent />);
  });
